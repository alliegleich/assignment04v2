...
```{r}
ggplot(data = gss, aes(x = HAPPY)) + geom_histogram(position = "dodge", width = 10.5, na.rm = TRUE) +  scale_x_continuous(breaks = c(1, 2, 3)) + scale_y_continuous(limits = c(0, NA)) + theme_classic() + geom_text(aes(x =2,y = 2010, label = "median", size = 0.5, show.legend = FALSE)) +
  labs(
